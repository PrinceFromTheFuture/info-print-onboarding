...
export function CustomerDetailDialog({
  ...
  const { mutateAsync: approveUser, isPending: isApproving } = useMutation(
    trpc.customerRouter.approveUser.mutationOptions()
  ) as unknown as {
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <Badge
                        variant={customer.isApproved ? "default" : "destructive"}
                ...
                {!customer.isApproved && (
                  <div className="flex flex-col gap-2">
                    ...
                    <p className="text-xs text-muted-foreground text-center">
                      Approve this user to grant full access
                    </p>
                  </div>
                )}
              </div>
            ...
            <div className="flex flex-1 overflow-hidden">
              ...
              <ScrollArea className="flex-1 max-h-[calc(90vh-180px)]">
                <div className="p-6 space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">
                      {customer.onboardingProgress === 100
                        ...
                        : `${
                            customer.assignedTemplates.length -
                            customer.submissions.filter((s) => s.progress === 100).length
                          } templates remaining`}
                    </p>
                  </div>
                    ...
                    <div className="grid bg-foreground/4 p-4 rounded-sm grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium font-mono">
                          {generateUnsecurePassword({ userName: customer.email.split("@")[0] })}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
                  ...
                  {customer.appUserConfig ? (
                    <>
                      <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="space-y-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm font-medium">
                                {customer.appUserConfig.administratorFullName}
                              </p>
                            </div>
                            <div>
                              <label className="text-sm font-medium text-muted-foreground">Email</label>
                          ...
                          <div className="space-y-3">
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-2">
                                <Badge
                                  variant={customer.appUserConfig.quickBooksSyncing ? "default" : "secondary"}
                                >
                        ...
                        {customer.appUserConfig.otherFeatures &&
                          customer.appUserConfig.otherFeatures.length > 0 && (
                            <div>
                              <label className="text-sm font-medium text-muted-foreground">
                                Additional Features
                              </label>
                                ...
                                <div className="border rounded-lg p-3 hover:bg-muted/50 transition-colors">
                                  ...
                                  >
                                    <div className="shrink-0">
                                      {getFileIcon(customer.appUserConfig.logo.type)}
                                    </div>
                                    <div className="flex-1 min-w-0">
                                      <p className="text-xs font-medium truncate">
                                        {customer.appUserConfig.logo.name}
                                      </p>
                            ...
                            {customer.appUserConfig.contactAndCompanyList && (
                              <div className="space-y-2">
                                ...
                                <div className="border rounded-lg p-3 hover:bg-muted/50 transition-colors">
                                  ...
                                  >
                                    <div className="shrink-0">
                                      {getFileIcon(customer.appUserConfig.contactAndCompanyList.type)}
                                    </div>
                                    <div className="flex-1 min-w-0">
                                      <p className="text-xs font-medium truncate">
                                        {customer.appUserConfig.contactAndCompanyList.name}
                                      </p>
                            ...
                            {customer.appUserConfig.inventoryList && (
                              <div className="space-y-2">
                                ...
                                <div className="border rounded-lg p-3 hover:bg-muted/50 transition-colors">
                                  ...
                                  >
                                    <div className="shrink-0">
                                      {getFileIcon(customer.appUserConfig.inventoryList.type)}
                                    </div>
                                    <div className="flex-1 min-w-0">
                                      <p className="text-xs font-medium truncate">
                                        {customer.appUserConfig.inventoryList.name}
                                      </p>
                            ...
                            {customer.appUserConfig.machineInformation && (
                              <div className="space-y-2">
                                ...
                                <div className="border rounded-lg p-3 hover:bg-muted/50 transition-colors">
                                  ...
                                  >
                                    <div className="shrink-0">
                                      {getFileIcon(customer.appUserConfig.machineInformation.type)}
                                    </div>
                                    <div className="flex-1 min-w-0">
                                      <p className="text-xs font-medium truncate">
                                        {customer.appUserConfig.machineInformation.name}
                                      </p>
                              ...
                              <div className="space-y-2 md:col-span-2">
                                ...
                                <div className="border rounded-lg p-3 hover:bg-muted/50 transition-colors">
                                  ...
                                  >
                                    <div className="shrink-0">
                                      {getFileIcon(
                                        customer.appUserConfig.additionalProductPricingInformation.type
                                      )}
                                    </div>
                                    <div className="flex-1 min-w-0">
                                      <p className="text-xs font-medium truncate">
                    ...
                    <>
                      <div className="space-y-3">
                        ...
                        <Alert>
                          ...
                          <AlertDescription>
                            This user has not yet completed their company configuration setup. The
                            configuration data will appear here once they submit their onboarding information.
                          </AlertDescription>
                        </Alert>
                      </div>
                      <Separator />
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <h3 className="text-base font-semibold">
                        Assigned Templates ({customer.assignedTemplates.length})
                      </h3>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-56">
                          ...
                          {availableTemplates.filter(
                            (t) => !customer.assignedTemplates.find((at) => at.id === t.id)
                          ).length === 0 && (
                    ...
                    <div className="flex flex-wrap gap-2">
                      {customer.assignedTemplates.map((template) => (
                        <Badge
                          key={template.id}
                          variant="secondary"
                          className="gap-1.5 py-1.5 px-3 font-normal"
                        >
                  ...
                  <div className="space-y-3">
                    <h3 className="text-base font-semibold">
                      Form Submissions ({customer.submissions.length})
                    </h3>
                    <div className=" flex flex-col gap-3">
                      {customer.submissions.map((submission) => (
                        <Link
                          ...
                          target="_blank"
                          key={submission.id}
                          href={`/viewForm/${submission.templateId}/${customerId}`}
                        >
                          <div className="border rounded-lg p-3 hover:bg-muted/50 transition-colors">
