  ...
  return (
    <FieldGroup>
      <Field>
        ...
        {form.formState.errors.companyName && <p className="text-sm text-red-500 mt-1">{form.formState.errors.companyName.message as string}</p>}
      ...
      <Field>
        ...
        <Input id="companyWebsiteUrl" placeholder="https://yourcompany.com" {...form.register("companyWebsiteUrl")} />
        {form.formState.errors.companyWebsiteUrl && (
          <p className="text-sm text-red-500 mt-1">{form.formState.errors.companyWebsiteUrl.message as string}</p>
        )}
      ...
      <Field>
        ...
        {form.formState.errors.requestedDomain && (
          <p className="text-sm text-red-500 mt-1">{form.formState.errors.requestedDomain.message as string}</p>
        )}
        <FieldDescription>
          Choose your custom subdomain <strong>{form.watch("requestedDomain")}.infoflopay.com</strong>
        </FieldDescription>
      </Field>
    </FieldGroup>
  );
