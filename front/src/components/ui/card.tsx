...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return <div data-slot="card" className={cn(" bg-sidebar text-card-foreground flex flex-col      gap-6 rounded-xl  py-6 ", className)} {...props} />;
}
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return <div data-slot="card-title" className={cn("leading-none text-xl  font-semibold", className)} {...props} />;
}
